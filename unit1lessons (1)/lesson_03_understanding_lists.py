...
- Lists are like string arrays
- Lists are mutable
- List function is similar to stack - pop, insert, concat,append, reverse
- Can be sliced in similar fashion as string
- Can auto-gen range .. range used to return list in Py2 now returns a range object which needs to be converted to list
-
"""
